...
public class Deliveryman implements Serializable {
    ...
    private String telefone; //Nao é a mesma coisa que contato? usar somente essa
    private LoadedAddress loadedAddress;
    private String pais; //Foi add
    private String numero; //Foi add
    ...
    public Deliveryman(String nome, Bitmap foto, String contato, String email, String senha,
                       ...
                       boolean isAvailable, int nivel, int experiencia, float media, String numero, String pais) {
    ...
    public Deliveryman(String nome, Bitmap foto, String contato, String email, String senha,
                       ...
                       String conta, String numero, String pais) {
        this.nome = nome;
        this.foto = foto;
        this.contato = contato;
        this.email = email;
